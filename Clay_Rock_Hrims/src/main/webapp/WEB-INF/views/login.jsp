...
<body style="background-color: white;">
	<div class="container" align="center" style="margin-top: 12%;">
		<div style="vertical-align: top; margin: 10px 10px 10px 10px;">
			<img width="200px;" height="50px;" src="<%=request.getContextPath()%>/images/logo_clay_rock.jpg">
		</div>
		<form id="login" name="login" action="<%=request.getContextPath()%>/login.clay_rock" method="post" style="max-width: 360px; margin: 0px auto;">
